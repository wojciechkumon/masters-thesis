...
\acknowledgements{Serdecznie dziękuję mgr inż. Michałowi \mbox{Wypychowi} za poświęcony czas i wszelkie \mbox{wskazówki} w czasie powstawania tej pracy.}
...
\include{architektura_systemu}
\include{algorytm_weryfikacji}
\include{rozproszona_implementacja}
