...
Wykorzystuję heurystykę opartą na algorytmie MAP, która w wielu przypadkach wykryje akceptujący cykl i zakończy procedurę.
...
\end{itemize}
Warto zauważyć, że algorytmy poziomu 0 bywają także rozważane jako niedziałające w locie.
