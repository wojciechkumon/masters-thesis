...
% TODO opis checkStates, on-the-fly + parallel()
...
% TODO napisac o serwisach ogarniajacych odczyt/zapis z casasndry
% StoredLtlAutomaton opis pol, poprzednik, stan do ktorego pasuje itp


\section{Baza danych}

% cassandra, jej wybor bo skalowalna, ale tez wady (ACID), opis tabelek (z kolumnami)
